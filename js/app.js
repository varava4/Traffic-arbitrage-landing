    ...
    (() => {
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if (showMoreType === "items") {
                        const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 1;
        ...
        function initSliders() {
            if (document.querySelector(".offer__slider")) new swiper_core_Swiper(".offer__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".slide-offer-arrow--prev",
                    nextEl: ".slide-offer-arrow--next"
                },
                on: {}
            });
            if (document.querySelector(".tarif__slider")) new swiper_core_Swiper(".tarif__slider", {
